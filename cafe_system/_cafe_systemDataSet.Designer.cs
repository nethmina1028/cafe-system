...
namespace cafe_system {
    ...
    public partial class _cafe_systemDataSet : global::System.Data.DataSet {
        ...
        public partial class inventoryDataTable : global::System.Data.TypedTableBase<inventoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public inventoryRow AddinventoryRow(int ProductId, string ProductName, string Type, int Stock, decimal Price, string Status, System.DateTime Date) {
...
namespace cafe_system._cafe_systemDataSetTableAdapters {
    ...
    public partial class inventoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[inventory] WHERE (([ProductId] = @Original_ProductId) AND ([ProductName] = @Original_ProductName) AND ([Type] = @Original_Type) AND ([Stock] = @Original_Stock) AND ([Price] = @Original_Price) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[inventory] SET [ProductId] = @ProductId, [ProductName] = @ProductName, [Type] = @Type, [Stock] = @Stock, [Price] = @Price, [Status] = @Status, [Date] = @Date WHERE (([ProductId] = @Original_ProductId) AND ([ProductName] = @Original_ProductName) AND ([Type] = @Original_Type) AND ([Stock] = @Original_Stock) AND ([Price] = @Original_Price) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)));
SELECT ProductId, ProductName, Type, Stock, Price, Status, Date FROM inventory WHERE (ProductId = @ProductId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductId, ProductName, Type, Stock, Price, Status, Date FROM dbo.inventor" +
                "y";
        ...
        public virtual int Fill(_cafe_systemDataSet.inventoryDataTable dataTable) {
        ...
        public virtual _cafe_systemDataSet.inventoryDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            _cafe_systemDataSet.inventoryDataTable dataTable = new _cafe_systemDataSet.inventoryDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(_cafe_systemDataSet.inventoryDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ProductId, string Original_ProductName, string Original_Type, int Original_Stock, decimal Original_Price, string Original_Status, global::System.Nullable<global::System.DateTime> Original_Date) {
        ...
        public virtual int Update(int ProductId, string ProductName, string Type, int Stock, decimal Price, string Status, global::System.Nullable<global::System.DateTime> Date, int Original_ProductId, string Original_ProductName, string Original_Type, int Original_Stock, decimal Original_Price, string Original_Status, global::System.Nullable<global::System.DateTime> Original_Date) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, string Type, int Stock, decimal Price, string Status, global::System.Nullable<global::System.DateTime> Date, int Original_ProductId, string Original_ProductName, string Original_Type, int Original_Stock, decimal Original_Price, string Original_Status, global::System.Nullable<global::System.DateTime> Original_Date) {
            return this.Update(Original_ProductId, ProductName, Type, Stock, Price, Status, Date, Original_ProductId, Original_ProductName, Original_Type, Original_Stock, Original_Price, Original_Status, Original_Date);
        }
    }

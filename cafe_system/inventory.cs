...
namespace cafe_system
{
    ...
    public partial class inventory : UserControl
    {
        ...
        {
            int ID = int.Parse(inven_pId.Text);
            string Name = inven_Pname.Text;
        ...
        private void Inven_imagebox_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO [inventory] (ID, Name, Price, Stock, Type, Image) VALUES (@ProductId, @ProductName, @Price, @Stock, @Type, @ImageData)";
        ...
        private void Inven_btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            string query = "UPDATE [inventory] SET Name = @Name, Price = @Price, Stock = @Stock, Type = @Type, Image=@ImageData WHERE ID = @ID";

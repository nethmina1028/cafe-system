...
namespace cafe_system {
    ...
    public partial class Database5DataSet : global::System.Data.DataSet {
        ...
        public partial class cafeDataTable : global::System.Data.TypedTableBase<cafeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public cafeRow AddcafeRow(int ProductId, string ProductName, string Type, int Stock, int Price, string Status, int Date, byte[] Image) {
        ...
        public partial class cafeRow : global::System.Data.DataRow {
            ...
            public int Date {
                get {
                    try {
                        return ((int)(this[this.tablecafe.DateColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace cafe_system.Database5DataSetTableAdapters {
...
SELECT ProductId, ProductName, Type, Stock, Price, Status, Date, Image FROM cafe WHERE (ProductId = @ProductId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::cafe_system.Properties.Settings.Default.Database5ConnectionString;
        }
        ...
        public virtual int Fill(Database5DataSet.cafeDataTable dataTable) {
        ...
        public virtual Database5DataSet.cafeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database5DataSet.cafeDataTable dataTable = new Database5DataSet.cafeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database5DataSet.cafeDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ProductId, string Original_ProductName, string Original_Type, int Original_Stock, int Original_Price, string Original_Status, global::System.Nullable<int> Original_Date) {
            ...
            if ((Original_Date.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((int)(Original_Date.Value));
            }
            else {
        ...
        public virtual int Insert(int ProductId, string ProductName, string Type, int Stock, int Price, string Status, global::System.Nullable<int> Date, byte[] Image) {
            ...
            if ((Date.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[6].Value = ((int)(Date.Value));
            }
            else {
        ...
        public virtual int Update(int ProductId, string ProductName, string Type, int Stock, int Price, string Status, global::System.Nullable<int> Date, byte[] Image, int Original_ProductId, string Original_ProductName, string Original_Type, int Original_Stock, int Original_Price, string Original_Status, global::System.Nullable<int> Original_Date) {
            ...
            if ((Date.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Date.Value));
            }
            else {
            ...
            if ((Original_Date.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[16].Value = ((int)(Original_Date.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, string Type, int Stock, int Price, string Status, global::System.Nullable<int> Date, byte[] Image, int Original_ProductId, string Original_ProductName, string Original_Type, int Original_Stock, int Original_Price, string Original_Status, global::System.Nullable<int> Original_Date) {
